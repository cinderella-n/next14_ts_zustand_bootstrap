...
export class UserApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createUser(body: User, _options?: Configuration): Promise<RequestContext> {
        ...
        if (body === null || body === undefined) {
            throw new RequiredError("UserApi", "createUser", "body");
        }
     ...
     */
    public async createUsersWithArrayInput(body: Array<User>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("UserApi", "createUsersWithArrayInput", "body");
        }
     ...
     * @param body List of user object
     */
    public async createUsersWithListInput(body: Array<User>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("UserApi", "createUsersWithListInput", "body");
        }
     ...
     */
    public async updateUser(username: string, body: User, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("UserApi", "updateUser", "body");
        }
