...
export class PetApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addPet(body: Pet, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("PetApi", "addPet", "body");
        }
     ...
     * @param body Pet object that needs to be added to the store
     */
    public async updatePet(body: Pet, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'body' is not null or undefined
        if (body === null || body === undefined) {
            throw new RequiredError("PetApi", "updatePet", "body");
        }
