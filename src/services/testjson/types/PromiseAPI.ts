...
export class PromisePetApi {
     ...
     */
    public addPetWithHttpInfo(body: Pet, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.addPetWithHttpInfo(body, _options);
     ...
     * @param body Pet object that needs to be added to the store
     */
    public addPet(body: Pet, _options?: Configuration): Promise<void> {
        const result = this.api.addPet(body, _options);
        return result.toPromise();
    }
     ...
     * @param body Pet object that needs to be added to the store
     */
    public updatePetWithHttpInfo(body: Pet, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.updatePetWithHttpInfo(body, _options);
        return result.toPromise();
    }
     ...
     * @param body Pet object that needs to be added to the store
     */
    public updatePet(body: Pet, _options?: Configuration): Promise<void> {
        const result = this.api.updatePet(body, _options);
        return result.toPromise();
    }
...
export class PromiseStoreApi {
     ...
     */
    public placeOrderWithHttpInfo(body: Order, _options?: Configuration): Promise<HttpInfo<Order>> {
        const result = this.api.placeOrderWithHttpInfo(body, _options);
        return result.toPromise();
    }
     ...
     * @param body order placed for purchasing the pet
     */
    public placeOrder(body: Order, _options?: Configuration): Promise<Order> {
        const result = this.api.placeOrder(body, _options);
        return result.toPromise();
    }
...
export class PromiseUserApi {
     ...
     */
    public createUserWithHttpInfo(body: User, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.createUserWithHttpInfo(body, _options);
        return result.toPromise();
    }
     ...
     * @param body Created user object
     */
    public createUser(body: User, _options?: Configuration): Promise<void> {
     ...
     */
    public createUsersWithArrayInputWithHttpInfo(body: Array<User>, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.createUsersWithArrayInputWithHttpInfo(body, _options);
        return result.toPromise();
    }
     ...
     * @param body List of user object
     */
    public createUsersWithArrayInput(body: Array<User>, _options?: Configuration): Promise<void> {
        const result = this.api.createUsersWithArrayInput(body, _options);
        return result.toPromise();
    }
     ...
     * @param body List of user object
     */
    public createUsersWithListInputWithHttpInfo(body: Array<User>, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.createUsersWithListInputWithHttpInfo(body, _options);
        return result.toPromise();
    }
     ...
     * @param body List of user object
     */
    public createUsersWithListInput(body: Array<User>, _options?: Configuration): Promise<void> {
        const result = this.api.createUsersWithListInput(body, _options);
        return result.toPromise();
    }
     ...
     */
    public updateUserWithHttpInfo(username: string, body: User, _options?: Configuration): Promise<HttpInfo<void>> {
        const result = this.api.updateUserWithHttpInfo(username, body, _options);
        return result.toPromise();
    }
     ...
     * @param body Updated user object
     */
    public updateUser(username: string, body: User, _options?: Configuration): Promise<void> {
        const result = this.api.updateUser(username, body, _options);
        return result.toPromise();
    }
