...
export class ObservablePetApi {
     ...
     */
    public addPetWithHttpInfo(body: Pet, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.addPet(body, _options);
     ...
     * @param body Pet object that needs to be added to the store
     */
    public addPet(body: Pet, _options?: Configuration): Observable<void> {
        return this.addPetWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     * @param body Pet object that needs to be added to the store
     */
    public updatePetWithHttpInfo(body: Pet, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.updatePet(body, _options);
     ...
     * @param body Pet object that needs to be added to the store
     */
    public updatePet(body: Pet, _options?: Configuration): Observable<void> {
        return this.updatePetWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
...
export class ObservableStoreApi {
     ...
     */
    public placeOrderWithHttpInfo(body: Order, _options?: Configuration): Observable<HttpInfo<Order>> {
        const requestContextPromise = this.requestFactory.placeOrder(body, _options);
     ...
     * @param body order placed for purchasing the pet
     */
    public placeOrder(body: Order, _options?: Configuration): Observable<Order> {
        return this.placeOrderWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<Order>) => apiResponse.data));
    }
...
export class ObservableUserApi {
     ...
     */
    public createUserWithHttpInfo(body: User, _options?: Configuration): Observable<HttpInfo<void>> {
     ...
     * @param body Created user object
     */
    public createUser(body: User, _options?: Configuration): Observable<void> {
        return this.createUserWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public createUsersWithArrayInputWithHttpInfo(body: Array<User>, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.createUsersWithArrayInput(body, _options);
     ...
     * @param body List of user object
     */
    public createUsersWithArrayInput(body: Array<User>, _options?: Configuration): Observable<void> {
        return this.createUsersWithArrayInputWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     * @param body List of user object
     */
    public createUsersWithListInputWithHttpInfo(body: Array<User>, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.createUsersWithListInput(body, _options);
     ...
     * @param body List of user object
     */
    public createUsersWithListInput(body: Array<User>, _options?: Configuration): Observable<void> {
        return this.createUsersWithListInputWithHttpInfo(body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
     ...
     */
    public updateUserWithHttpInfo(username: string, body: User, _options?: Configuration): Observable<HttpInfo<void>> {
        const requestContextPromise = this.requestFactory.updateUser(username, body, _options);
     ...
     * @param body Updated user object
     */
    public updateUser(username: string, body: User, _options?: Configuration): Observable<void> {
        return this.updateUserWithHttpInfo(username, body, _options).pipe(map((apiResponse: HttpInfo<void>) => apiResponse.data));
    }
